...
- (void) completeTransaction: (SKPaymentTransaction *)transaction
{
    ...
    [[SKPaymentQueue defaultQueue] finishTransaction: transaction];
    UIAlertView *congrat=[[UIAlertView alloc]initWithTitle:@"Congratulations" message:@"You can view the history of your Salik & Parking " delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    [congrat show];
}
